...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // all 99 Callable objects before it had finished. That is not very efficient.
        // Let's say, for instance that these callables were all alternative ways of doing something -
